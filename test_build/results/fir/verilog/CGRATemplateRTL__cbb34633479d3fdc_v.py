#=========================================================================
# VCGRATemplateRTL__cbb34633479d3fdc_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__cbb34633479d3fdc
#-------------------------------------------------------------------------

class CGRATemplateRTL__cbb34633479d3fdc( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__cbb34633479d3fdc_v.so', os.path.getmtime( './libCGRATemplateRTL__cbb34633479d3fdc_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__cbb34633479d3fdc_v.so')

    # increment instance count
    CGRATemplateRTL__cbb34633479d3fdc.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__cbb34633479d3fdc.verilator1.vcd"
